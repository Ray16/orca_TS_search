...
echo "=== Step 0: Generating SN2 TS guess XYZ files ==="
python3 0_prep_initial_TS_structure.py --family sn2
...
for sys in "${SYSTEMS[@]}"; do
  ...
  # Step 1: Generate ORCA input from TS guess
  echo "  Step 1a: Preparing TS search input..."
  python3 1_prep_TS_search.py "$sys" --charge -1 --mult 1 \
    --root "$RUNS_DIR" \
